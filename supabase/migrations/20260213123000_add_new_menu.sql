...
BEGIN
    ...
    -- BURGERS
    INSERT INTO menu_items (name, description, price, category, popular, available) VALUES
    ...
    LOOP
        INSERT INTO menu_items (name, price, category, popular, available, description)
    ...
    -- PREMIUMS
    INSERT INTO menu_items (name, price, category, popular, available, description) VALUES ('Meiji Apollo', 85, v_premiums_cat_id, false, true, 'Premium Drink') RETURNING id INTO v_item_id;
    INSERT INTO variations (menu_item_id, name, price) VALUES (v_item_id, 'Medium', 85), (v_item_id, 'Large', 95);

    INSERT INTO menu_items (name, price, category, popular, available, description) VALUES ('Milo G', 100, v_premiums_cat_id, false, true, 'Premium Drink') RETURNING id INTO v_item_id;
    INSERT INTO variations (menu_item_id, name, price) VALUES (v_item_id, 'Medium', 100), (v_item_id, 'Large', 110);

    INSERT INTO menu_items (name, price, category, popular, available, description) VALUES ('Brown Sugar Latte', 100, v_premiums_cat_id, false, true, 'Premium Drink') RETURNING id INTO v_item_id;
    INSERT INTO variations (menu_item_id, name, price) VALUES (v_item_id, 'Large', 100);

    INSERT INTO menu_items (name, price, category, popular, available, description) VALUES ('Taro Halo-Halo', 95, v_premiums_cat_id, false, true, 'Premium Drink') RETURNING id INTO v_item_id;
    ...
    INSERT INTO menu_items (name, price, category, popular, available, description) VALUES ('Cafe Americano', 50, v_coffee_cat_id, false, true, 'Hot/Cold Coffee') RETURNING id INTO v_item_id;
